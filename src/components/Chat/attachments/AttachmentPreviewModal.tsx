...
export default function AttachmentPreviewModal({ attachment, onOpenChange }: AttachmentPreviewModalProps) {
  if (!attachment) return null;

  return (
    <Dialog open={!!attachment} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[80vw] sm:max-w-[80vw] lg:max-w-4xl w-full h-[80vh] flex flex-col p-0" showCloseButton={false} onInteractOutside={(e) => e.preventDefault()}>
        <TooltipProvider>
