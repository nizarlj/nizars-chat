...
const scrollbarStyle = "scrollbar-thin scrollbar-track-transparent scrollbar-thumb-accent scrollbar-thumb-rounded-md";
        ...
        >
          <Providers>
            ...
            <div className="relative flex-1 flex">
              ...
              <main className={cn("flex-1 flex overflow-y-auto", scrollbarStyle, "scrollbar-gutter-stable")}>
